...
fn should_return_emtpy_when_not_has_matches() {
    let board = crate::domain::board::board::Board::emtpy_3x3();
    let result = board.matches(crate::domain::tile::tile::PieceType::A);
...
fn should_return_tree_tile_when_has_one_vertical_match() {
    ...
    board.do_move(crate::domain::tile::tile::Tile{x: 0, y: 1, piece: crate::domain::tile::tile::PieceType::A});
...
fn should_return_six_tile_when_has_two_vertical_matches() {
    ...
    board.do_move(crate::domain::tile::tile::Tile{x: 1, y: 1, piece: crate::domain::tile::tile::PieceType::A});
    board.do_move(crate::domain::tile::tile::Tile{x: 1, y: 2, piece: crate::domain::tile::tile::PieceType::A});
    let result = board.matches(crate::domain::tile::tile::PieceType::A);
...
fn should_return_nine_tile_when_has_tree_vertical_matches() {
    ...
    board.do_move(crate::domain::tile::tile::Tile{x: 1, y: 1, piece: crate::domain::tile::tile::PieceType::A});
    board.do_move(crate::domain::tile::tile::Tile{x: 1, y: 2, piece: crate::domain::tile::tile::PieceType::A});
    board.do_move(crate::domain::tile::tile::Tile{x: 2, y: 0, piece: crate::domain::tile::tile::PieceType::A});
    board.do_move(crate::domain::tile::tile::Tile{x: 2, y: 1, piece: crate::domain::tile::tile::PieceType::A});
...
fn should_return_nine_tile_when_has_tree_horizontal_matches() {
    ...
    board.do_move(crate::domain::tile::tile::Tile{x: 2, y: 1, piece: crate::domain::tile::tile::PieceType::B});
    board.do_move(crate::domain::tile::tile::Tile{x: 0, y: 2, piece: crate::domain::tile::tile::PieceType::A});
    board.do_move(crate::domain::tile::tile::Tile{x: 1, y: 2, piece: crate::domain::tile::tile::PieceType::A});
    board.do_move(crate::domain::tile::tile::Tile{x: 2, y: 2, piece: crate::domain::tile::tile::PieceType::A});
    let result = board.matches(crate::domain::tile::tile::PieceType::A);
...
fn should_return_nine_tile_when_has_doble_diagonal_matches() {
    let mut board = crate::domain::board::board::Board::emtpy_3x3();
    board.do_move(crate::domain::tile::tile::Tile{x: 0, y: 0, piece: crate::domain::tile::tile::PieceType::A});
    board.do_move(crate::domain::tile::tile::Tile{x: 1, y: 0, piece: crate::domain::tile::tile::PieceType::B});
    board.do_move(crate::domain::tile::tile::Tile{x: 2, y: 0, piece: crate::domain::tile::tile::PieceType::A});
    board.do_move(crate::domain::tile::tile::Tile{x: 0, y: 1, piece: crate::domain::tile::tile::PieceType::B});
    board.do_move(crate::domain::tile::tile::Tile{x: 1, y: 1, piece: crate::domain::tile::tile::PieceType::A});
    board.do_move(crate::domain::tile::tile::Tile{x: 2, y: 1, piece: crate::domain::tile::tile::PieceType::B});
...
fn should_return_drow_when_do_not_has_matches() {
    let board = crate::domain::board::board::Board::emtpy_3x3();
    assert_eq!(board.get_result(), crate::domain::board::board::RoundResult::NoFinished);
}
...
fn should_return_b_when_has_a_diagonal_match() {
    let mut board = crate::domain::board::board::Board::emtpy_3x3();
    board.do_move(crate::domain::tile::tile::Tile{x: 0, y: 0, piece: crate::domain::tile::tile::PieceType::B});
    board.do_move(crate::domain::tile::tile::Tile{x: 1, y: 1, piece: crate::domain::tile::tile::PieceType::B});
    board.do_move(crate::domain::tile::tile::Tile{x: 2, y: 2, piece: crate::domain::tile::tile::PieceType::B});
